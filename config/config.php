...
if (TL_MODE == 'BE')
{
    $GLOBALS['TL_CSS'][] = \Haste\Util\Debug::uncompressedFile('system/modules/isotope_order_export/assets/css/backend.css|static');
    $GLOBALS['TL_JAVASCRIPT'][] = \Haste\Util\Debug::uncompressedFile('system/modules/isotope_order_export/assets/js/backend.js|static');
}
